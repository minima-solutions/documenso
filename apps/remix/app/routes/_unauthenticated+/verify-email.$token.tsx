      ...
      <div className="w-screen max-w-lg px-4">
        <div className="flex w-full items-start">
          ...
          <div>
            ...
            <p className="text-muted-foreground mt-4">
              <Trans>
                Your email has been successfully confirmed! You can now use all features of MINIMA
                Sign.
              </Trans>
            </p>
      ...
      <div className="w-screen max-w-lg px-4">
        <div className="flex w-full items-start">
          ...
          <div>
            ...
            <p className="text-muted-foreground mt-4">
              <Trans>
                Your email has already been confirmed. You can now use all features of MINIMA Sign.
              </Trans>
            </p>
